...
DISPLAY_top macro  register
        	movff  register,BYTE
        	call  ByteDisplay_top
        	endm

DISPLAY_bottom  macro  register
        		movff  register,BYTE
        		call  ByteDisplay_bottom
        		endm
...
CHECK
			...
			;2) Check if conversion is complete

          ;btg  PORTC,RC2               ;Toggle pin, to support measuring loop time
          ;rcall  BlinkAlive            ;Blink "Alive" LED
          DISPLAY_top  ADRESH               ;Display PORTD as a binary number
		  DISPLAY_bottom  ADRESL               ;Display PORTD as a binary number
...
MOVLF  B'10000101',ADCON2      ;Enable PORTA & PORTE digital I/O pins -----
...
RL10
        ...
        MOVLF  0x86,BYTESTR            ;Add cursor-positioning code
